  ...
  Widget _buildProductDetailsCard() {
    ...
    if (item['type'] == 'Multiple') {
      return ProductCardMultiple(
        ...
        postedDate: PostViewUtils.formatDate(item['orderDate'] ?? item['created_on'] ?? item['fromdate']),
        expireDate: PostViewUtils.formatDate(item['deliverydate'] ?? item['expiredate']),
        minimumOrder: _formatToKg(item['minimumqty']),
